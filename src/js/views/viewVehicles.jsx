                ...
                <div className="row g-0">
                    ...
                    <div className="col-md-8">
                        <div className="card-body">
                            <h1 className="card-title text-center">{detailVehicle.name}</h1>
            ...
            <div className='container mt-5 text-danger text-center'>
                <div className='row g-0'>
                    <div className='col-md-2'>
                        <strong>Name</strong>
                        <p>{detailVehicle.name}</p>
                    </div>
                    <div className='col-md-2'>
                        <strong>Model</strong>
                        <p>{detailVehicle.model}</p>
                    </div>
                    <div className='col-md-2'>
                        <strong>Vehicle Class</strong>
                        <p>{detailVehicle.vehicle_class}</p>
                    </div>
                    <div className='col-md-2'>
                        <strong>Passengers</strong>
                        <p>{detailVehicle.passengers}</p>
                    </div>
                    <div className='col-md-2'>
                        <strong>Crew</strong>
                        <p>{detailVehicle.crew}</p>
                    </div>
                </div>
            </div>
        </div>
