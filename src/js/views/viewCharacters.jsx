...
export const ViewCharacters = () => {
    ...
    function getDetailCharacter() {
        fetch("https://swapi.dev/api/people/" + params.theid)
            .then((res) => res.json())
            .then((data) => setDetailCharacter(data))
                ...
                <div className="row g-0">
                    ...
                    <div className="col-md-8">
                        <div className="card-body">
                            <h1 className="card-title text-center">{detailCharacter.name}</h1>
            ...
            <div className='container mt-5 text-danger text-center'>
                <div className='row g-0'>
                    <div className='col-md-2'>
                        <strong>Name</strong>
                        <p>{detailCharacter.name}</p>
                    </div>
                    <div className='col-md-2'>
                        <strong>Birth Year</strong>
                        <p>{detailCharacter.birth_year}</p>
                    </div>
                    <div className='col-md-2'>
                        <strong>Eye Color</strong>
                        <p>{detailCharacter.eye_color}</p>
                    </div>
                    <div className='col-md-2'>
                        <strong>Skin Color</strong>
                        <p>{detailCharacter.skin_color}</p>
                    </div>
                    <div className='col-md-2'>
                        <strong>Height</strong>
                        <p>{detailCharacter.height}</p>
                    </div>
                </div>
            </div>
        </div>
